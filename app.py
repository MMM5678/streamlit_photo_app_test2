...
if img_file is not None:
    ...
    temp_file = os.path.join(fpath, "temp.png")

    shutil.copyfile(temp_file, file_path)
    #os.rename(img_file, file_path)
    ...
    #image_selected = cv2.imread(img_file.name)
    print("img_file.name="+img_file.name)
    #print(img_file)
